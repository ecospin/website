...
const games = [
    ...
    { category: "originals", image: "cases.png", name: "Cases", link: "cases.html" },
    ...
    { category: "slots", image: "spin.png", name: "Sugar Rush", link: "spin.html" },   
...
// Lista de jocuri jucate recent
const recentlyPlayedGames = [
    { image: "mines.png", name: "Mines", lastPlayed: "2 hours ago" },
    { image: "plinko.png", name: "Plinko", lastPlayed: "3 hours ago" },
    { image: "crash.png", name: "Crash", lastPlayed: "5 hours ago" },
    { image: "limbo.png", name: "Limbo", lastPlayed: "1 day ago" },
];

// Funcție pentru a afișa jocurile jucate recent
function displayRecentlyPlayed() {
    const recentGamesContainer = document.querySelector('.recent-games');
    recentGamesContainer.innerHTML = ''; // Șterge jocurile existente

    recentlyPlayedGames.forEach(game => {
        const recentGame = document.createElement('div');
        recentGame.classList.add('recent-game');
        ...
        recentGamesContainer.appendChild(recentGame);
    });
}

// Inițializare
window.addEventListener('load', () => {
    displayRecentlyPlayed(); // Afișează jocurile jucate recent
});